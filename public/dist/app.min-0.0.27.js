...
},{"./clearFormData":30,"./getFormData":50,"./isArray":72,"./isInputCheckable":77,"./q":88,"./qa":89,"./re":91,"./setValue":99}],49:[function(require,module,exports){
"use strict";
...
function fieldValue(fieldEl) {
  return (0, _domHelpers.q)(fieldEl, 'input');
}
...
function open(fieldEl) {
  ...
  _OptionsPanel["default"].open(getOptionsEl(fieldEl), {
     ...
     */
    positionEl: (0, _domHelpers.q)(fieldEl, 'input'),
...
function close(fieldEl) {
  ...
  _OptionsPanel["default"].close(getOptionsEl(fieldEl), {
...
function checkOptionsListId(fieldEl) {
  ...
  var optionsEl = (0, _domHelpers.q)(fieldEl, '.options');
  if (optionsEl) {
    if (!optionsEl.id) {
...
function getOptionsEl(fieldEl) {
  if (fieldEl.dataset.optionsListId) {
    return (0, _domHelpers.q)("#".concat(fieldEl.dataset.optionsListId));
  }
  return (0, _domHelpers.q)(fieldEl, '.options');
}
var _default = exports["default"] = {
  init: function init() {
    ...
    (0, _domHelpers.qa)('.field-select').forEach(function (fieldEl) {
      var checkedOptionEl = _OptionsPanel["default"].findOptionByValue(getOptionsEl(fieldEl), fieldValue(fieldEl).value);
  ...
  setTimeout(function () {
    ...
    setTimeout(function () {
      ...
      if ((0, _domHelpers.r)(optionsEl).fieldSearch) {
        ...
        (0, _domHelpers.r)(optionsEl).fieldSearch.focus();
      } else {
        optionsEl.focus();
      }
    }, 5);
...
function _close(optionsEl) {
  ...
  if (optionsEl == _SingletonPanel["default"].getContentEl()) {
    ...
    if ((0, _domHelpers.r)(optionsEl).fieldSearch) {
      (0, _domHelpers.r)(optionsEl).fieldSearch.value = '';
    }
...
var _default = exports["default"] = {
  ...
  open: function open(optionsEl) {
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    _open(optionsEl, options);
  },
  close: function close(optionsEl) {
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    _close(optionsEl, options);
  },
