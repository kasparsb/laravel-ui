        ...
        if ($col->type == 'field-text') {
            ...
            return view(
                ...
                $this->getClassConstructorParameters(FieldSelect::class, [
                    ...
                    'sourceMethod' => $col->selectSourceMethod,
                    'sourceLoadFrequency' => $col->selectSourceLoadFrequency,
                    'sourceFormData' => $col->selectSourceFormData,
                    'sourceSelfName' => $col->selectSourceSelfName,
